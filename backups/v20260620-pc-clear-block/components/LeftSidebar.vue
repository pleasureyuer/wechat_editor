    ...
    <div class="panel-content">
      ...
      <div v-else-if="activeNav === 'interactive'" class="panel-section">
        ...
        <div class="interactive-placeholder">
          ...
          <div class="ip-text">互动组件开发中</div>
          <div class="ip-desc">投票、留言、调查问卷等功能即将上线，敬请期待</div>
        </div>
      </div>
...
.ip-icon { font-size: 36px; margin-bottom: 12px; opacity: 0.6; }
.ip-text { font-size: 14px; font-weight: 600; color: #888; margin-bottom: 6px; }
.ip-desc { font-size: 12px; color: #bbb; line-height: 1.6; }
