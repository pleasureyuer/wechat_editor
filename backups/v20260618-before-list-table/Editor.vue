...
function applyBlockStyle(compType) {
  ...
  let stepNum
  if (compType === 'stepTitle') {
    // 如果目标已是步骤标题，保留原编号
    if (targetEl.classList.contains('style-step-title')) {
      const b = targetEl.querySelector('b')
      if (b) {
