...
function applyBlockStyle(compType) {
  ...
  // 支持「标题+正文」双段卡片的组件类型
  const TITLE_BODY_CARDS = ['topicSectionCard','waistSealRounded','bambooJoint','doubleLayerFrame','doubleLayerFrameRound']
  // 只填充正文内容区、保留组件默认开头/结尾的组件类型
  const BODY_ONLY_CARDS = ['qaBox']
